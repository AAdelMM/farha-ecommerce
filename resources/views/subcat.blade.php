...
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
        ...
        @elseif (App::currentLocale() == 'ar')
            {{$cat->subcategory_name_ar}}   
        @endif   
              
        </strong> @lang('messages.products')</span>
        <span class="bg-secondary  float-right">
            <div class="dropdown filter">
                <button class="btn btn-block btn-secondary dropdown-toggle" style="width: 150px" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @lang('messages.sort')
                </button>
